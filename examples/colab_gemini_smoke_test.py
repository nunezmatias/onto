...
def main() -> None:
    base_paras = [
        "Green roofs mitigate urban heat island effects and reduce runoff.",
        "Floods cause severe damage in coastal areas and affect agriculture.",
        "Early warning systems protect populations during intense storms.",
        "Constructed wetlands prevent flooding and complement grey infrastructure.",
    ]
